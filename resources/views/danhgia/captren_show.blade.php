            ...
            <div class="col-12">
                <div class="card card-default">
                    <div class="card-body">
                        ...
                        @endif
                        <h6>&emsp;&emsp;&emsp;- Đơn vị: {{ $phieu_danh_gia->phong->ten_phong }}, {{ $phieu_danh_gia->don_vi->ten_don_vi }}
                        </h6>
                        <br>
                        ...
                        <div class="form-group">
                            <textarea class="form-control" id="ly_do_diem_cong" name="ly_do_diem_cong" rows="7" readonly>@if ($ly_do_diem_cong) {{ $ly_do_diem_cong->noi_dung }} @endif</textarea>
                        </div>
                        {{-- Mục Lý do Điểm trừ --}}
                        <h6>&emsp;&emsp;&emsp;- Lý do áp dụng điểm trừ: <i>(mô tả tóm tắt)</i></h6>
                        <div class="form-group">
                            <textarea class="form-control" id="ly_do_diem_tru" name="ly_do_diem_tru" rows="7" readonly>@if ($ly_do_diem_tru) {{ $ly_do_diem_tru->noi_dung }} @endif</textarea>
                        </div>
                        ...
                        <table class="table table-borderless">
                            ...
                            <tbody>
                                <tr>
                                    {{-- Xếp loại A --}}
                                    <td class="text-center">
                                        <input type="radio" name="cap_tren_xep_loai" value="A" id="hoan_thanh_xuat_sac"
                                            class="form-control"
                                    ...
                                    {{-- Xếp loại B --}}
                                    <td class="text-center">
                                        <input type="radio" name="cap_tren_xep_loai" value="B" id="hoan_thanh_tot"
                                            class="form-control"
                                    ...
                                    {{-- Xếp loại D --}}
                                    <td class="text-center">
                                        <input type="radio" name="cap_tren_xep_loai" value="D" id="khong_hoan_thanh"
                                            class="form-control"
